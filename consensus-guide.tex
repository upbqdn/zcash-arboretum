...
block less than 100 blocks prior to the spend'' (\href{https://zips.z.cash/protocol/protocol.pdf\#txnconsensus}{\S7.1.2}) --- miners wait $n = 100$
...
(citing the draft ZIP-315); the spend anchor ---
...
zero-knowledge paths'') --- sits $3$ blocks below the target height. The
...
shielded need no confirmations at all; its UI reports a transaction
\emph{confirmed} at $10$ confirmations. These constants are wallet policy
