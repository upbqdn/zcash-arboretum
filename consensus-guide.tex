...
(ZIP-208; \textsf{PostBlossomPoWTargetSpacing}, specification \href{https://zips.z.cash/protocol/protocol.pdf\#constants}{\S5.3}),
...
($156{,}250{,}000$~zatoshi, specification \href{https://zips.z.cash/protocol/protocol.pdf\#subsidies}{\S7.8}),
...
(specification \href{https://zips.z.cash/protocol/protocol.pdf\#zip214fundingstreams}{\S7.10.1}; ZIP-1016) --- leaving the miner
\[
...
not. The specification (\href{https://zips.z.cash/protocol/protocol.pdf\#diffadjustment}{\S7.7.3}) adopts ``a difficulty adjustment
...
block height'' (\href{https://zips.z.cash/protocol/protocol.pdf\#diffadjustment}{\S7.7.3}), so the attacker's chain retunes from the
attacker's own timestamps, subject to the timestamp rules ---
\texttt{nTime} strictly above the median of the preceding $11$, at
most $90 \times 60$ seconds above it (\href{https://zips.z.cash/protocol/protocol.pdf\#blockheader}{\S7.6}), and at most two hours
...
\texttt{zcashd} and \texttt{zebra} this limit is 100 blocks'' (\href{https://zips.z.cash/protocol/protocol.pdf\#blockchain}{\S3.3}).
...
recent settled network upgrade'' (\href{https://zips.z.cash/protocol/protocol.pdf\#blockchain}{\S3.3}) --- history
...
block less than 100 blocks prior to the spend'' (\href{https://zips.z.cash/protocol/protocol.pdf\#txnconsensus}{\S7.1.2};
