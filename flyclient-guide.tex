...
treatment of the note-commitment tree (\S``Resting: the note in the commitment
tree'') rather than re-deriving Merkle mechanics;
...
(\emph{Ironwood Guide}, \S``The turnstile and migration''). ZIP-258 remains
