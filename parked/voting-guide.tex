...
ElGamal encryption, whose IND-CPA security (indistinguishability under
chosen-plaintext attack; the \emph{Crypto Guide}, \S``Security as a
game'') holds for any valid key ---
...
published analysis states. On that evidence the protocol is fit for the
use provisioned for June 2026 --- a non-binding sentiment poll with
publicly recomputable totals --- though that use has yet to occur
(\S\ref{sec:vote-shipped}). Binding governance would additionally
