...
\texttt{cf801a5d}). The Asset Identifier is therefore not serialized as a
...
\texttt{src/issuance/auth.rs} lines~163--303 @ \texttt{cf801a5d}).
...
$\GroupHash^{\Pallas}(\mathtt{z.cash:Orchard\text{-}cv},$ $\texttt{"v"})$,
\texttt{orchard-zsa}, \texttt{src/\allowbreak note/\allowbreak
asset\_base.rs},
\texttt{src/\allowbreak constants/\allowbreak fixed\_bases.rs}).
