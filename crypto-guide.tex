...
specification \href{https://zips.z.cash/protocol/protocol.pdf\#poseidonhash}{\S~5.4.1.10}). It is used in
...
\item \emph{Double SHA-256 (SHA-256d, or \(\mathsf{hash256}\)).} The
  ...
  before converting to base~58 (protocol specification \href{https://zips.z.cash/protocol/protocol.pdf\#transparentaddrencoding}{\S~5.6.1.1};
  ...
  specification \href{https://zips.z.cash/protocol/protocol.pdf\#txnidentifiers}{\S~7.1.1}; \texttt{zcash\_primitives} crate,
...
(\texttt{src/bundle.rs}; protocol specification \href{https://zips.z.cash/protocol/protocol.pdf\#orchardbalance}{\S~4.14}). The
