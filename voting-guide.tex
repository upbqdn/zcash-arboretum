...
Guide}, \emph{Tachyon Guide} --- documents the shielded voting protocol
...
\item \emph{Real nullifier} (condition~12). The circuit derives the note's
  ...
  deployed Orchard rule, constructed in the \emph{Orchard Guide}
...
\emph{Orchard Guide} (\S``Prevention of double-spending: nullifiers'') ---
\[
\nfsym_{\mathrm{signed}} =
...
witnessed randomizer $\alpha$ (the \emph{Orchard Guide},
