...
\begin{frame}{Unlinkability: the wallet boundary}
\begin{itemize}
...
\begin{frame}{Unified addresses: pools and viewing keys}
\begin{itemize}
...
\begin{frame}{What the signatures sign: the anchor and the txid}
\begin{itemize}
...
\begin{frame}{The inner-product argument: verification and binding}
\begin{itemize}
...
\begin{frame}{Three circuit versions, one selected verifying key}
...
\begin{tabular}{@{}lp{0.71\textwidth}@{}}
\toprule
...
\begin{frame}{Rosenfeld eq.~(1): the race doubling}
...
\begin{frame}{Satoshi's approximation: comparison with the exact risk}
\begin{center}
\begin{tabular}{@{}rrrr@{}}
\toprule
...
\begin{center}
\begin{tikzpicture}[x=1.05cm, y=0.69cm, >={Stealth[length=2mm]},
...
\begin{frame}{The hashed trapdoor: ownership after a quantum break}
\begin{itemize}
...
\begin{center}\small
\begin{tabular}{@{}p{0.11\textwidth}p{0.49\textwidth}p{0.30\textwidth}@{}}
\toprule
...
\begin{center}\small
\begin{tabular}{@{}p{0.11\textwidth}p{0.83\textwidth}@{}}
\toprule
...
\begin{frame}{Backup: the standing of sources}
\begin{itemize}
...
\begin{gather*}
\text{CT: } [v]\,V + [r]\,R; \quad
\text{Pedersen hash: } \textstyle\sum_{j} [m_j]\,P_j; \\
...
\begin{frame}{Backup: why the seal lives in consensus}
\begin{itemize}
