...
\newcommand{\src}[1]{\par\smallskip{\footnotesize\color{arbdim}\raggedright Source: #1\par}}
...
none of the labels.
\src{\emph{Ironwood Guide}, ``Requirements on a shielded payment''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Requirements on a shielded payment''; ``The note
  commitment tree''}
\end{board}
...
\src{\emph{Crypto Guide}, ``Three questions''; ``The sealed envelope'';
  \emph{Ironwood Guide}, ``The nullifier''}
\end{board}
...
lives inside the proof.
\src{\emph{Crypto Guide}, ``The Pedersen commitment''; \emph{Ironwood Guide},
  ``Value commitments''; ``The Action statement''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Notes''; ``Randomised validating keys'';
  \emph{FROST Guide}, ``The three deployment surfaces''}
\end{board}
...
derived from it.
\src{\emph{Ironwood Guide}, ``Notes and note commitments''; ``The Merkle hash
  and the tree''; ``Nullifier sets''}
\end{board}
...
\src{\emph{Crypto Guide}, ``Privacy-preserving membership via zero-knowledge
  paths''; ``A shielded spend, end to end''; \emph{Ironwood Guide}, ``Value
  commitments and the binding signature''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Requirements on a shielded payment''; ``The Action
  statement''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Nullifiers''}
\end{board}
...
\src{\emph{Crypto Guide}, ``Arithmetisation-friendly hashing: Poseidon'';
  ...
  ``Sinsemilla: hash, commitment, and short forms'', Remark ``Cost inside a
  proof''; protocol specification, ``JoinSplit Statement (Sprout)''}
\end{board}
...
\src{\emph{Crypto Guide}, ``Authentication paths and membership proofs'';
  \emph{Ironwood Guide}, ``The Merkle hash and the tree''}
\end{board}
...
\src{\emph{Crypto Guide}, ``Append-only and incrementally updatable trees'';
  ...
  \emph{Ironwood Guide}, ``The note commitment tree''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The nullifier''; ``Nullifier uniqueness''}
\end{board}
...
\src{\emph{Crypto Guide}, ``Elliptic-curve Diffie--Hellman''; ``Shielded-note
  delivery as deployed hybrid encryption''; \emph{Ironwood Guide}, ``Encryption
  to the recipient''}
\end{board}
...
change: no --- Part F.
\src{\emph{Crypto Guide}, ``Key-derivation functions''; ``The ChaCha20-Poly1305
  AEAD''; \emph{Ironwood Guide}, ``Encryption to the recipient''}
\end{board}
...
\src{\emph{Crypto Guide}, ``Key re-randomisation and unlinkability'';
  \emph{Ironwood Guide}, ``Randomised validating keys''}
\end{board}
...
\src{\emph{Crypto Guide}, ``SNARKs: succinct non-interactive arguments of
  knowledge''; \emph{Ironwood Guide}, ``The Action circuit and the Halo 2
  proof''}
\end{board}
...
spend list (Part E).
\src{\emph{Ironwood Guide}, ``The transaction format''; \emph{Crypto Guide},
  ``SNARKs: succinct non-interactive arguments of knowledge'';
  protocol specification, ``JoinSplit Descriptions''; ``Constants''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Action circuit and the Halo 2 proof'';
  ``Privacy''; \emph{Crypto Guide}, ``Hiding and binding''; ``Key
  re-randomisation and unlinkability''}
\end{board}
...
the answer.
\src{\emph{Crypto Guide}, ``The transparent layer's hashes''; ``Instantiation on
  elliptic curves; the Pasta curves''; ``Shielded-note delivery as deployed
  hybrid encryption''; ``RedDSA: re-randomisable Schnorr for Orchard'';
  \emph{Ironwood Guide}, ``The Merkle hash and the tree''; ``The nullifier''}
\end{board}
...
this part).
\src{\emph{Ironwood Guide}, ``Notes''; ``The note seed: Ironwood derivations
  (lead byte 0x03)''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Orchard protocol and its two pools''; ``Chain
  state and pool rules''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Chain state and pool rules''}
\end{board}
...
circuit.
\src{\emph{Ironwood Guide}, ``Sinsemilla: hash, commitment, and short forms'',
  Remark ``Cost inside a proof''; \emph{Crypto Guide},
  ``Arithmetisation-friendly hashing: Poseidon''}
\end{board}
...
Part F).
\src{\emph{Ironwood Guide}, ``Note commitments''; ``Sinsemilla: hash,
  commitment, and short forms''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Note commitments''; ``Sinsemilla: hash,
  commitment, and short forms''; \emph{Crypto Guide}, ``Hiding and binding''}
\end{board}
...
pool.
\src{\emph{Ironwood Guide}, ``The Merkle hash and the tree''; ``Nullifier
  sets''; protocol specification, ``Note Commitment Trees''; ``Nullifier Sets''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Merkle hash and the tree'';
...
\src{\emph{Ironwood Guide}, ``Actions, bundles, and dummy notes''; ``Note
  encryption''; ``Value commitments''}
\end{board}
...
broadcast.
\src{\emph{Ironwood Guide}, ``The Merkle hash and the tree''; ``Anchors'';
  ``Authentication paths''; \emph{Wallet Guide}, ``Frontiers as scan seeds'';
...
\src{\emph{Ironwood Guide}, ``Anchors''; \emph{Wallet Guide}, ``Confirmations,
...
\src{\emph{Ironwood Guide}, ``Anchors''; \emph{Wallet Guide}, ``Reorganisations:
  truncate and rescan''; ``PCZT v2: deferred anchors and the Ironwood bundle''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The note commitment tree''; ``Anchors''; ``Chain
  state and pool rules''}
\end{board}
...
Part E.
\src{\emph{Ironwood Guide}, ``The nullifier''; \emph{Crypto Guide},
  ``Arithmetisation-friendly hashing: Poseidon''; protocol specification,
  ``Dummy Notes (Orchard)''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Nullifier uniqueness and unlinkability''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Authentication paths''; ``The nullifier'';
  ``Verification of a transaction''; ``Trial decryption and note acceptance''}
\end{board}
...
\end{itemize}
\src{\emph{Wallet Guide}, ``Internal keys: change and auto-shielding'';
\emph{Ironwood Guide}, ``Chain state and pool rules''}
\end{board}
...
\end{itemize}
\src{\emph{Ironwood Guide}, ``Key capabilities and scope''; ``Viewing keys'';
``The Action statement''; protocol specification, ``Orchard Key Components''}
\end{board}
...
\begin{itemize}
  \item ``The pair $(\dk, \ovk)$ comes from \ivk.'' Row~4 starts at
    \fvk.
\end{itemize}
\src{\emph{Ironwood Guide}, ``Key capabilities and scope''; \emph{Wallet Guide},
``Diversified addresses''; protocol specification, ``Orchard Key Components''}
\end{board}
...
\end{itemize}
\src{\emph{Ironwood Guide}, ``Key capabilities and scope''; ``The outgoing
...
\end{itemize}
\src{\emph{Ironwood Guide}, ``Key capabilities and scope''; ``Verification of a
transaction''; \emph{Wallet Guide}, ``Unified viewing keys''}
\end{board}
...
\src{\emph{Wallet Guide}, ``Unified addresses''; ``String encoding: F4Jumble and
Bech32m''; ``Unified viewing keys''; \emph{Ironwood Guide}, ``Key capabilities
and scope''; ZIP-316, ``Encoding of Unified Addresses''}
\end{board}
...
\begin{itemize}
  ...
  \item ``Change is recovered via \ovk.'' Change is an incoming note in
    ...
    $\mathtt{0x83}$ step.
\end{itemize}
\src{\emph{Ironwood Guide}, ``Encryption to the recipient''; ``Notes and note
commitments''; ``Key capabilities and scope''; ``The outgoing ciphertext'';
\emph{Wallet Guide}, ``Unified addresses''; ``Internal keys: change and
auto-shielding''; ``From the account key to addresses: the layer already
built''; ``Unified viewing keys''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Actions, bundles, and dummy notes''; ``The
outgoing ciphertext''; ``The Action statement''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Verification of a transaction''; ``Action
descriptions and bundles''}
\end{board}
...
\src{\emph{Wallet Guide}, ``Padding, dummies, and shuffling'';
\emph{Ironwood Guide}, ``Actions, bundles, and dummy notes''}
\end{board}
...
logic.
\src{\emph{Ironwood Guide}, ``The Action statement''; ``The Action circuit and
the Halo 2 proof''; protocol specification, ``Action Statement (Orchard)''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Action statement''; ``Requirements on a
shielded payment''; ``Verification of a transaction''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Action statement''; \emph{Wallet Guide},
``Padding, dummies, and shuffling''; ``The conventional fee''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Authentication paths''; ``Anchors''; ``The Action
statement''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The nullifier''; ``Verification of a
transaction''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Randomised validating keys''; \emph{Crypto Guide},
``Key re-randomisation and unlinkability''}\par}
\end{board}
...
is proved.
\src{\emph{Ironwood Guide}, ``The Action statement''; ``Authorisation of
spends''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Note commitments''; ``Nullifier chaining''; ``The
Action statement''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Value commitments''; ``Value conservation''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Action statement''; ``Chain state and pool
rules''; ``Bundle flags''}
\end{board}
...
this one can.
\src{\emph{Ironwood Guide}, ``The Action statement'', Remark ``Meaning of A10'';
``Bundle flags''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Chain state and pool rules''; ``Actions, bundles,
and dummy notes''; ``Verification of a transaction''. Checkpoint:
\emph{Ironwood Guide}, ``The Action statement''; ``The Action circuit and the
Halo 2 proof''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Value commitments''; \emph{Crypto Guide}, ``The
Pedersen commitment''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Action statement''; ``Value conservation'';
\emph{Crypto Guide}, ``The Pedersen commitment''}
\end{board}
...
commitments.
\src{\emph{Ironwood Guide}, ``The binding signature''; ``Value conservation'';
\emph{Crypto Guide}, ``Binding signatures as a proof of knowledge of a discrete
logarithm''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The balancing value''; ``Chain state and pool
rules''; \emph{Wallet Guide}, ``The conventional fee''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The RedPallas signature scheme''; ``The
transaction format''; \emph{Crypto Guide}, ``RedDSA: re-randomisable Schnorr for
Orchard''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Randomised validating keys''; \emph{Crypto Guide},
``Key re-randomi\-sation and unlinkability''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Transaction digests and signatures'';
\emph{Wallet Guide}, ``Build order and signatures''}
\end{board}
...
\end{itemize}
\src{\emph{Wallet Guide}, ``Padding, dummies, and shuffling''; ``Build order and
signatures''; \emph{Ironwood Guide}, ``The binding signature''. Checkpoint:
\emph{Ironwood Guide}, ``Verification of a transaction''; ``Construction of a
transaction''; ``The transaction format''}
\end{board}
...
\src{\emph{Crypto Guide}, ``The simulation paradigm and zero knowledge'';
\emph{Ironwood Guide}, ``The Action circuit and the Halo 2 proof''; ``Privacy''}
\end{board}
...
evaluation domain.
\src{\emph{Ironwood Guide}, ``The Action circuit and the Halo 2 proof'';
\emph{Math Guide}, ``Base fields, scalar fields, and the Pasta cycle''}
\end{board}
...
exit.
\src{\emph{Crypto Guide}, ``Polynomial commitment schemes''; ``SNARKs: succinct
non-interactive arguments of knowledge''; \emph{Halo 2 Guide}, ``The ``Halo'' in
Halo 2: deferring the expensive check''; \emph{Ironwood Guide}, ``Chain state
and pool rules''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Action circuit and the Halo 2 proof''; ``The
transaction format''; protocol specification, ``Zero-Knowledge Proving
Systems''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Action circuit and the Halo 2 proof''; ``The
transaction format''; \emph{Halo 2 Guide}, ``The complete Halo 2 protocol''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Action circuit and the Halo 2 proof'';
\emph{Halo 2 Guide}, ``From statement to circuit: arithmetisation in practice''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Action statement''; \emph{Halo 2 Guide},
``Instance columns and binding the public statement''; checkpoint:
\emph{Crypto Guide}, ``SNARKs: succinct non-interactive arguments of
knowledge''; \emph{Ironwood Guide}, ``Chain state and pool rules''}
\end{board}
...
\end{itemize}
\src{\emph{Ironwood Guide}, ``The note plaintext''; ``The note seed: Ironwood
  derivations (lead byte $\mathtt{0x03}$)''; protocol specification, ``Note
  Plaintexts and Memo Fields''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The note seed: Ironwood derivations (lead byte
  $\mathtt{0x03}$)''; protocol specification, ``Sending Notes (Orchard)''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The note seed: Ironwood derivations (lead byte
  $\mathtt{0x03}$)'', Remark ``Purpose of the hashed trapdoor''; ``The Action
  statement'', Remark ``What the statement does not check''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Encryption to the recipient'';
  protocol specification, ``In-band secret distribution (Sapling and Orchard)''}
\end{board}
...
\end{itemize}
\src{\emph{Ironwood Guide}, ``The outgoing ciphertext''; ``The note plaintext'';
  protocol specification, ``Decryption using an Outgoing Viewing Key (Sapling
  and Orchard)''}
\end{board}
...
\end{itemize}
\src{\emph{Ironwood Guide}, ``Trial decryption and note acceptance'';
  \emph{Wallet Guide}, ``Compact blocks (ZIP-307)''; protocol specification,
  ``Decryption using an Incoming Viewing Key (Sapling and Orchard)''}
\end{board}
...
\src{\emph{Wallet Guide}, ``Compact blocks (ZIP-307)''; ``The deployed
  messages''; ``Omissions and fetch-on-detect''; \emph{Ironwood Guide}, ``Action
  descriptions and bundles''; ``Transaction digests and signatures''}
\end{board}
...
\src{\emph{Wallet Guide}, ``Compact trial decryption'';\\ \emph{Ironwood Guide},
  ``Trial decryption and note acceptance''}
\end{board}
...
\src{\emph{Wallet Guide}, ``Scanning: spends, positions, and tree sizes'';
  \emph{Ironwood Guide}, ``Authentication paths''}
\end{board}
...
is ever public.
\src{\emph{Ironwood Guide}, ``Authentication paths''; \emph{Wallet Guide},
  ``Client state: shards, cap, and retention''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Anchors''; \emph{Wallet Guide}, ``Client state:
  shards, cap, and retention''; ``Reorganisation detection and recovery''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Anchors''; ``Authentication paths''}
\end{board}
...
\end{itemize}
\src{\emph{Ironwood Guide}, ``Anchors''; \emph{Wallet Guide}, ``Confirmations,
  trust, and spendability''; ``Executing the proposal''}
\end{board}
...
\end{itemize}
\src{\emph{Ironwood Guide}, ``Trial decryption and note acceptance''; ``The
  outgoing ciphertext''; \emph{Wallet Guide}, ``Internal keys: change and
  auto-shielding''; ``Executing the proposal''; ``Confirmations, trust, and
  spendability''. Checkpoint: \emph{Wallet Guide}, ``What never leaves the
  device''; ``Leaks in the deployed pattern''; ``The submission channel''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The transaction format''; \emph{Crypto Guide},
  ``The transparent layer's schemes: ECDSA and BIP-340 over secp256k1''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Transaction digests and signatures''; ``The
  transaction format''; \emph{Crypto Guide}, ``The transparent layer's hashes'';
  \emph{FlyClient Guide}, ``Why an authorising-data root exists'';
  \emph{Wallet Guide}, ``PCZT v2: deferred anchors and the Ironwood bundle''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Transaction digests and signatures'';
  \emph{Wallet Guide}, ``Serialisation and the transaction identifier''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Transaction digests and signatures'';
  ``Verification of a transaction''; \emph{Wallet Guide}, ``Signing'';
  ``Proving''}
\end{board}
...
turnstile.
\src{\emph{Ironwood Guide}, ``Chain state and pool rules'', Remark ``Outflow
  bound''; ZIP-2005, ``Effects of discrete-logarithm-breaking attacks before the
  switch to the Recovery Protocol''; ZIP-209; protocol specification, ``Chain
  Value Pool Balances''; ``BCTV14''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Chain state and pool rules''; ``The Action circuit
  and the Halo 2 proof''; ``The note seed: Ironwood derivations (lead byte
  $\mathtt{0x03}$)'', Remark ``Purpose of the hashed trapdoor''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The transaction format''; ``Anchors''; ``The
  balancing value''; \emph{Wallet Guide}, ``Padding, dummies, and shuffling'';
  ``Expiry (ZIP-203)''}
\end{board}
...
\src{\emph{Wallet Guide}, ``Unified addresses''; ``Input selection''; ``Expiry
  (ZIP-203)''; ZIP-318, ``Amount selection, canonical quantization'';
...
\src{\emph{Wallet Guide}, ``Partially created transactions (PCZT)'';
  ``Combining, redaction, and privacy''; ``The deployed wallet pipeline'';
  ``PCZT v2: deferred anchors and the Ironwood bundle''; \emph{Ironwood Guide},
  ``The balancing value''; ``Anchors''; ``Nullifier uniqueness and
  unlinkability''; ZIP-318, ``Amount selection, canonical quantization'';
  ``Anchor-height bucketing and cohorts''}
\end{board}
...
\src{protocol specification, ``Nullifier Sets''; \emph{Ironwood Guide},
  ``Verification of a transaction''; ``Nullifier sets''}
\end{board}
...
\src{protocol specification, ``Transactions and Treestates''; ``Action Transfers
  and their Descriptions''; \emph{Ironwood Guide}, ``Anchors''; ``Chain state
  and pool rules''; \emph{Wallet Guide}, ``PCZT v2: deferred anchors and the
  Ironwood bundle''}
\end{board}
...
support pending.
\src{\emph{Ironwood Guide}, ``Anchors''; \emph{Wallet Guide}, ``Reorganisations:
  truncate and rescan''; protocol specification, ``Transactions and
  Treestates''; ``Nullifier Sets''; \emph{Consensus Guide}, ``Playing
  catch-up''; ``What the numbers say''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The end-to-end theorem''; ``Privacy'';
``Anchors''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Notes''; ``Key capabilities and scope'';
\emph{Wallet Guide}, ``Wallet seeds''; ``Partially created transactions
(PCZT)''; \emph{FROST Guide}, ``Scope''}
\end{board}
...
calendar.
\src{\emph{Crypto Guide}, ``The quantum caveat: Shor's algorithm''; ZIP-2005,
``Effects of discrete-logarithm-breaking attacks before the switch to the
Recovery Protocol''; ``Effects of discrete-logarithm-breaking attacks after the
switch to the Recovery Protocol''}
\end{board}
...
layer.
\src{\emph{Ironwood Guide}, ``Encryption to the recipient''; ``Trial decryption
and note acceptance''; ZIP-2005, ``Effects of discrete-logarithm-breaking
attacks after the switch to the Recovery Protocol''}
\end{board}
...
$(\dk, \ovk)$ from \ivk.
\src{\emph{Ironwood Guide}, ``Key capabilities and scope''; ZIP-2005,
``Motivation''; ``Non-requirements''}
\end{board}
...
auditable.''
\src{\emph{Ironwood Guide}, ``The end-to-end theorem''; ZIP-2005, ``Effects of
discrete-logarithm-breaking attacks before the switch to the Recovery
Protocol''}
\end{board}
...
\src{\emph{Crypto Guide}, ``The quantum caveat: Shor's algorithm''; ZIP-2005,
``Abstract''; ``Effects of discrete-logarithm-breaking attacks before the switch
...
the same ground.
\src{\emph{Crypto Guide}, ``The quantum caveat: Shor's algorithm''; ZIP-2005,
``Adaptation to the quantum setting''; ``Attacks addressed by the Recovery
Protocol''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The note seed: Ironwood derivations (lead byte
$\mathtt{0x03}$)'', Remark ``Purpose of the hashed trapdoor''; ``The Action
statement'', Remark ``What the statement does not check''; ``Chain state and
pool rules''; ZIP-2005, ``QROM lift of the security arguments''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The note seed: Ironwood derivations (lead byte
$\mathtt{0x03}$)'', Remark ``Purpose of the hashed trapdoor''; ZIP-2005,
``Abstract''; ``Proposed Recovery Statement''; ``Cost''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The note seed: Ironwood derivations (lead byte
$\mathtt{0x03}$)'', Remark ``Purpose of the hashed trapdoor''; ``The spending
key and the spend-side secrets''; ``Chain state and pool rules''; ZIP-2005,
``Proactive movement of funds to recoverable notes''; ``Proposed Recovery
Protocol''}
\end{board}
...
witness of A3 and never enters the nullifier.
\src{\emph{Ironwood Guide}, ``Requirements on a shielded payment'';
``Verification of a transaction''; ``The Action statement''}
\end{board}
...
not.
\src{\emph{Ironwood Guide}, ``Scope and status''; \emph{Consensus Guide},
...
version lives.
\src{\emph{Halo 2 Guide}, ``From statement to circuit: arithmetisation in
practice''; \emph{Wallet Guide}, ``Diversified and unified addresses
(ZIP-316)''; ``Normative status and wire-format history'';
\emph{Consensus Guide}, ``Sources and their standing''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The spending key and the spend-side secrets'';
``Viewing keys''; ``Notes''; ``The nullifier''; ``Randomised validating keys'';
\emph{Crypto Guide}, ``The transparent layer's schemes: ECDSA and BIP-340 over
secp256k1''}
\end{board}
...
\src{\emph{Math Guide}, ``Pallas and Vesta assembled''; ``Base fields, scalar
fields, and the Pasta cycle''; \emph{Halo 2 Guide}, ``A cycle of curves for
efficient native recursion''; \emph{Ironwood Guide}, ``The Action circuit and
the Halo 2 proof''; protocol specification, ``Pallas and Vesta''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Sinsemilla: hash, commitment, and short forms'',
Remark ``Cost inside a proof''; protocol specification, ``Sinsemilla Hash
Function''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Sinsemilla: hash, commitment, and short forms'';
``Note commitments''; ``The Merkle hash and the tree''; protocol specification,
...
\src{\emph{Crypto Guide}, ``Sinsemilla: an algebraic hash-based commitment'';
\emph{Ironwood Guide}, ``Sinsemilla: hash, commitment, and short forms'',
Proposition ``Collision resistance of the Sinsemilla instances''; Remark ``Cost
inside a proof''}
\end{board}
...
injective.
\src{\emph{Ironwood Guide}, ``Sinsemilla: hash, commitment, and short forms'',
Proposition ``Collision resistance of the Sinsemilla instances'';
...
generators at all.
\src{\emph{Ironwood Guide}, ``Sinsemilla: hash, commitment, and short forms'',
  Proposition ``Collision resistance of the Sinsemilla instances''; Remark
  ``Fixed length''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``The Action statement'', Remark ``Effect on the
  Orchard pool''; ``Actions, bundles, and dummy notes''}
\end{board}
...
address.
\src{\emph{Ironwood Guide}, ``Actions, bundles, and dummy notes''; ``The Action
  statement'', Remark ``Status''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Chain state and pool rules''; ZIP-258, ``Changes
to ZIP 209''; ``Changes to ZIP 221''; ZIP-318, ``Amount selection, canonical
quantization''}
\end{board}
...
\src{\emph{Ironwood Guide}, ``Encryption to the recipient''; ZIP-2005, ``Effects
of discrete-logarithm-breaking attacks after the switch to the Recovery
Protocol''; ``QROM lift of the security arguments''; ``Proposed Recovery
Statement''; ``Effects of discrete-logarithm-breaking attacks before the switch
to the Recovery Protocol''}
\end{board}
