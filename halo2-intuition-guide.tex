...
destroy. The alternative family of commitments buys smaller proofs at
the price of a \emph{trusted setup}: secret randomness drawn at a
ceremony, whose compromise forges proofs silently, and which Zcash's
earlier shielded pools in fact required (the \emph{Crypto Guide},
\S``Polynomial commitment schemes'', constructs that scheme, its
ceremony, and the forgery its trapdoor permits). Halo 2's inner-product
