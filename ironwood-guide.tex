...
\texttt{PostNu6\_3} in crate \texttt{orchard} at \texttt{bef8a27}
...
Action circuit and its keys: in crate \texttt{orchard} at \texttt{bef8a27}, the bundle
...
\texttt{orchard} at \texttt{bef8a27} \texttt{src/note.rs}). What changes is the note
...
\mathrm{LE}_{256}(\psi)
\]
(crate \texttt{orchard} at \texttt{bef8a27} \texttt{src/note.rs}, \texttt{rcm\_v3},
...
at \texttt{bef8a27} \texttt{src/note\_encryption.rs}). Because keys are protocol-scoped
