...
\draw[fork] ([yshift=-1.4mm]sk.east) to[out=-8,in=115] (nk.north west);
\draw[fork] ([yshift=1.2mm]sk.east)  to[out=8,in=95,looseness=0.8] (rivk.north);
...
The dev-tree \texttt{Note::rcm()} at \texttt{bef8a27} implements only this
