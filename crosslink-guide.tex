...
tree are those of the \emph{Orchard Guide} (\S``Proof of ownership of
...
cross-reference.
%% RESOLVED 2026-07-15: the caveat is in the \emph{Orchard Guide}, not
%% the Voting Guide --- orchard-guide.tex:1016-1018 (\S``Proof of
...
%% TODO: reconcile with the Orchard Guide's anchor caveat, which cites
%% ``anchoring at least 100 blocks deep (Zcash's reorg limit)''
%% (\emph{Orchard Guide}, \S``Proof of ownership of \emph{some} valid
...
(anchors are the tree roots developed in the \emph{Orchard Guide},
...
(\emph{Orchard Guide}, \S``Proof of ownership of \emph{some} valid note:
...
%% assumes the shared preamble of the series (orchard-guide.tex lines 1-90).
%%
...
time-to-market (ibid.). The pool being staked from is the one this series
constructs in the \emph{Orchard Guide} (\S``Representation of a note: notes
and note commitments''); nothing below alters its note machinery.
...
value-commitment machinery of the \emph{Orchard Guide} (\S``Conservation
...
Crosslink. The \emph{Orchard Guide} (\S``Proof of ownership of \emph{some}
...
%% TODO: file a cross-volume erratum against the Orchard Guide sentence
%% (orchard-guide.tex:1005-1034) once the volume owner confirms wording.
...
activation onward, with no sliding window (\emph{Orchard Guide},
\S``Proof of ownership of \emph{some} valid note: the commitment tree'',
...
\item \emph{Keep the tip-relative anchor.} ZIP 315's rule --- ``if the
  ...
  motivate near-tip anchoring (\emph{Orchard Guide}, ibid.), and retains
...
expiry semantics documented in the \emph{Orchard Guide} and \emph{Wallet
...
\emph{Orchard Guide}'s 100-block ``reorg horizon'' for anchor selection
...
policy''), and the \emph{Orchard Guide} records the 100-block reorg
