...
CASES = (
    ...
    ("ironwood-guide", "S2.html", "is a non-square in the Pallas base field", "math-guide", 768,
     "math"),
    ("ironwood-guide", "S9.html", "From statement to circuit", "halo2-guide", 1440, "keyboard"),
...
async def main(base):
    ...
    async with async_playwright() as playwright:
        ...
        for complete in (False, True):
            ...
            expected = [(prefix + 'S6.html#Thmtheorem3', '6.3'), (prefix + 'S6.html#SS3', '6.3')]
            for width in (390, 768, 1440):
                ...
                for index in (0, 1):
                    ...
                    await check_destination(page, target)
                print(f'{edition} {width}px: math references passed', flush=True)
