...
\emph{Orchard Guide}, \S``Representation of a note: notes and note
commitments'') and load-bearing zero-value dummies (\emph{Orchard Guide},
...
global, ever-growing nullifier set (the \emph{Orchard Guide},
...
generators (the \emph{Orchard Guide}, \S``Conservation of value: value
...
planner/custody split (\emph{Orchard Guide}, \S``Authorisation of the
