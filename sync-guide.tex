...
v0.4.1 & 2026-02-20 & nullifier RPCs designated deprecated in the
  proto \\
v0.5.0 (untagged) & 2026-06-30 & Ironwood fields added;
  \texttt{protoVersion} removed, field number~1 and name reserved \\
\bottomrule
\end{tabular}
\caption{Wire-format history of \textsf{lightwallet-protocol}
(\texttt{CHANGELOG.md}, librustzcash-vendored copy); v0.5.0 is a
changelog entry with no corresponding tag --- the latest tag is
v0.4.1.}%
...
node software at $3{,}428{,}143$); deployed \textsf{Zaino} wires both
...
(\texttt{zcash\_client\_backend/proto/service.proto} and
\texttt{compact\_formats.proto}) adds \texttt{IRONWOOD = 4},
\texttt{TreeState.ironwoodTree = 7},
\texttt{ShieldedProtocol.ironwood = 2},
\texttt{ChainMetadata.\allowbreak ironwoodCommitmentTreeSize = 3}, and
