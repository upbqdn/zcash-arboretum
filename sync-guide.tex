...
helpers \texttt{compact\_tx\_contains\_last\_}\allowbreak%
\texttt{sapling\_outputs\_in\_block},
\texttt{\ldots\_orchard\_actions\_in\_block}, and
\texttt{\ldots\_ironwood\_actions\_in\_block}
...
\texttt{hashBlockCommitments} and composed with the auth-data root at
NU5); no deployed client consumes
...
ironwood=2 \}}
(\texttt{lightwallet-protocol/walletrpc/service.proto:24--321}).
...
(\texttt{src/}\allowbreak\texttt{data\_api.rs:3743--3826}) fixes the
meaning:
