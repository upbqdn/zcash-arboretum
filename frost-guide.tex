...
\emph{Ironwood Guide}: \S``Spend authorisation: RedPallas re-randomisation'' builds
$\rsk := \ask + \alpha$ and
...
2026-08-30 found \textsf{frost} \texttt{0966bd1} and the same
\textsf{reddsa} head \texttt{3792daa}; the seven later FROST commits update
the Rust edition, minimum compiler, dependencies, and CI, not the
re-randomized protocol derived below.
...
\emph{Ironwood Guide}, \S``Spend authorisation: RedPallas re-randomisation''. Bin:
