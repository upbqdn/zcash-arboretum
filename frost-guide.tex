...
settled in the \emph{Ironwood Guide}: \S``Spend authorisation: RedPallas
re-randomisation'' constructs $\rsk := \ask + \alpha$ and
...
\S``Spend authorisation: RedPallas re-randomisation''), custody of the ZIP-2005
...
\emph{Ironwood Guide}: \S``Spend authorisation: RedPallas
re-randomisation'' builds
$\rsk := \ask + \alpha$ and
...
rule we cite those results and do not re-prove them. That proposition is an
EUF-CMA statement, not a separate proof of the protocol specification's
strong SURK-CMA notion.
...
\emph{Ironwood Guide}'s \S``RedPallas unforgeability'' shows honest uniform
re-randomisations are
...
the re-randomisation of the \emph{Ironwood Guide}, \S``Spend authorisation:
RedPallas re-randomisation'' --- and checks
