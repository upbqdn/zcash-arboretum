...
\max(\text{padded Sapling spends}, \text{padded Sapling outputs}) +
...
(\texttt{src/wallet.rs},
\texttt{get\_target\_}\allowbreak\texttt{and\_anchor\_heights}), the
heights are
\[
...
(\texttt{zcash\_client\_backend/src/fees.rs}, \texttt{ChangeStrategy}). The
deployed
...
(\texttt{wallet.rs}, \texttt{build\_proposed\_transaction}). The mechanics
are those of the
...
(\texttt{wallet.rs}, \texttt{create\_pczt\_from\_proposal};
\texttt{zcash\_primitives/src/}\allowbreak%
