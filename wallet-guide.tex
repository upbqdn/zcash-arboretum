...
$p_{\Vesta}$-element Pallas group when the blinding scalar is uniform. Here
...
\S5.4.9.7, note) --- so $\Pr[\ivk = 0] < 2^{-254}$.
...
$\Pr[\bot] \le 306/p_{\Vesta} < 306 \cdot 2^{-254}$, and per scope
$\Pr[\ivk \in \{0, \bot\}] < 307 \cdot 2^{-254} < 2^{-245}$. The internal scope
